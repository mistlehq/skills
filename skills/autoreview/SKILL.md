...
This repository checkout helper:
...
Installed OpenCode helper:

```bash
~/.config/opencode/skills/autoreview/scripts/autoreview --help
```

If installed from this repository into Codex, path is:
